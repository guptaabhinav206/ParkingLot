...
public class VehicleFactoryTest {
    ...
    private final boolean IS_ROYAL = false;
    ...
    public void shouldCreateVehicleWithCarType() {
        ...
        Assertions.assertEquals(vehicleFactory.createVehicle(VehicleType.CAR, VEHICLE_NUM_CAR, IS_ELDERLY, IS_ROYAL).toString(), createCarVehicle().toString());
    }

    @Test
    public void shouldCreateVehicleWithBikeType() {
        vehicleFactory = new VehicleFactory();
        Assertions.assertEquals(vehicleFactory.createVehicle(VehicleType.BIKE, VEHICLE_NUM_BIKE, IS_ELDERLY, IS_ROYAL).toString(), createBikeVehicle().toString());
    }
    ...
    public Vehicle createBikeVehicle() {
        return new Car(VehicleType.BIKE, "102", false, false);
    }
}
